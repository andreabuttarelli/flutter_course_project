...
///
/// Built on 2024-08-02 at 12:18 UTC
...
class Translations implements BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	String ciao({required Object name}) => 'Hello ${name}';
}
...
class _StringsIt implements Translations {
	...
	// Translations
	@override String ciao({required Object name}) => 'Ciao ${name}';
}
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			case 'ciao': return ({required Object name}) => 'Hello ${name}';
			default: return null;
		}
	}
}
...
extension on _StringsIt {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			case 'ciao': return ({required Object name}) => 'Ciao ${name}';
			default: return null;
		}
	}
}
