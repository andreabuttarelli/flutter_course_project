...
mixin _$FeedState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(Exception exc) error,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(Exception exc)? error,
...
class _$ErrorImpl implements _Error {
  ...
  @override
  String toString() {
    return 'FeedState.error(exc: $exc)';
  }
...
abstract class _Error implements FeedState {
  const factory _Error(final Exception exc) = _$ErrorImpl;
